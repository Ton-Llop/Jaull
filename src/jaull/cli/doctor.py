...
def _check_python() -> DiagnosticResult:
    # `requires-python = ">=3.12"` already prevents interpreters below that from installing
    # the package, so if this code runs at all the version constraint is satisfied.
