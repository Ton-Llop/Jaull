...
from local_ai_check.domain.inference import InferenceConfiguration, TargetDevice, WeightPrecision
from local_ai_check.domain.model import ModelRepositoryInfo

if TYPE_CHECKING:
    from local_ai_check.domain.runtime import RuntimeRecommendation
