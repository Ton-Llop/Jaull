...
from local_ai_check.discovery import candidate_filter, enrichment, query_builder
from local_ai_check.discovery.models import (
    EvaluatedCandidate,
    ModelCandidate,
    SearchQuery,
)
...
from local_ai_check.exceptions import HuggingFaceUnavailableError, LocalAiCheckError
from local_ai_check.recommendation import explanations
from local_ai_check.recommendation import service as recommendation_service
from local_ai_check.workflow import policies
from local_ai_check.workflow import requirements as requirements_service
from local_ai_check.workflow.cache import RunCache
...
from local_ai_check.workflow.progress import (
    DISCOVERY_STEPS,
    HARDWARE_STEPS,
    ProgressCallback,
    ProgressReporter,
...
def run_workflow(
    ...
    try:
        ...
        recommendations = recommendation_service.recommend(
            usable, requirements, limit=policies.MAX_RECOMMENDATIONS
        )
